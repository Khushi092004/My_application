    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        completeButton.setOnClickListener {
            ...
            if (selectedProcessor == "Processors" || selectedGraphicsCard == "Graphics Cards" || selectedRAM == "Ram" ||
                ...
                Toast.makeText(this@laminates, "Please complete the build by selecting options for all components.", Toast.LENGTH_SHORT).show()
            } else {
                val intent = Intent(this@laminates, Report::class.java)
